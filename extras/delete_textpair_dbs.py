...
if __name__ == '__main__':
    ...
    print(f"Dropping database {dbname}...", end="")
    cursor.execute(f"DROP DATABASE IF EXISTS {dbname}")
    print("done")
    print(f"Dropping database {dbname}__ordered...", end="")
    cursor.execute(f"DROP DATABASE IF EXISTS {dbname}__ordered")
    print("done")
    print(f"Dropping database {dbname}__groups...", end="")
    cursor.execute(f"DROP DATABASE IF EXISTS {dbname}___groups")
    print("done")
