...
Examples:
  ...
  python -m textpair_graph label ./output/graph_data --model unsloth/gemma-3-4b-it-qat-GGUF
    ...
    label_parser.add_argument('--top-k', type=int, default=15,
                             help='Number of top passages per cluster (default: 15)')
    label_parser.add_argument('--port', type=int, default=8081,
                             help='Port for llama-server (default: 8081)')
    ...
    if args.command == 'build':
        from .build_graph_model import build_alignment_data, cluster_alignments, build_author_cluster_graph
        import os
        import orjson
        import lz4.frame
